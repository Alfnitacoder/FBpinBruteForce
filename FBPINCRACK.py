...
class FacebookCracker(object):
  def __init__(self):
    self.InitFacebook('6785972889')

  def InitFacebook(self, fname):
    #setem up an index for later
    e=0
    #initializem selenium web driver
    #yu can easily change the driver to chrome or whichever you like
